...
## Tasks
0. [List all databases](#task0)
1. [Create a database](#task1)
2. [Insert document](#task2)
3. [All documents](#task3)
4. [All matches](#task4)
5. [Count](#task5)
6. [Update](#task6)
7. [Delete by match](#task7)
8. [List all documents in Python](#task8)
9. [Insert a document in Python](#task9)
...
### <a name="task1"></a>1. Create a database
...
### <a name="task2"></a>2. Insert document
...
### <a name="task3"></a>3. All documents
...
### <a name="task7"></a>7. Delete by match
...
### <a name="task8"></a>8. List all documents in Python
...
### <a name="task9"></a>9. Insert a document in Python
...
### <a name="task10"></a>10. Change school topics
...
### <a name="task11"></a>11. Where can I learn Python?
