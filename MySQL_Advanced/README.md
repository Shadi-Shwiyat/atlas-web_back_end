...
## Tasks
0. [We are all unique!](#task0)
1. [In and not out](#task1)
2. [Best band ever!](#task2)
3. [Old school band](#task3)
4. [Buy buy buy](#task4)
5. [Email validation to sent](#task5)
6. [Add bonus](#task6)
7. [Average score](#task7)
8. [Optimize simple search](#task8)
9. [Optimize search and score](#task9)
10. [Safe divide](#task10)
11. [No table for a meeting](#task11)

### <a name="task0"></a>0. We are all unique!
...
### <a name="task1"></a>1. In and not out
Write a SQL script that creates a table users following these requirements:
- With these attributes:
    - id, integer, never null, auto increment and primary key
    - email, string (255 characters), never null and unique
...
### <a name="task2"></a>2. Best band ever!
...
### <a name="task3"></a>3. Old school band
...
### <a name="task5"></a>5. Email validation to sent
...
### <a name="task7"></a>7. Average score
...
### <a name="task8"></a>8. Optimize simple search
...
### <a name="task9"></a>9. Optimize search and score
...
### <a name="task10"></a>10. Safe divide
...
### <a name="task11"></a>11. No table for a meeting
