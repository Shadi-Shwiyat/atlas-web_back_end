...
## Tasks
0. [Et moi et moi et moi!](#task0)
1. [Empty session](#task1)
2. [Create a session](#task2)
3. [User ID for Session ID](#task3)
4. [Session cookie](#task4)
5. [Before request](#task5)
6. [Use Session ID for identifying a User](#task6)
7. [New view for Session Authentication](#task7)
8. [Logout](#task8)

### <a name="task0"></a>0. Et moi et moi et moi!
...
### <a name="task1"></a>1. Empty session
...
### <a name="task2"></a>2. Create a session
...
### <a name="task3"></a>3. User ID for Session ID
Update SessionAuth class:
...
### <a name="task4"></a>4. Session cookie
...
### <a name="task5"></a>5. Before request
...
### <a name="task6"></a>6. Use Session ID for identifying a User
Update SessionAuth class:
...
### <a name="task7"></a>7. New view for Session Authentication
