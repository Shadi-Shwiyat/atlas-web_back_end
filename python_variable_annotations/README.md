...
### <a name="task3"></a>3. Basic annotations - to string
...
### <a name="task4"></a>4. Define variables
...
### <a name="task5"></a>5. Complex types - list of floats
...
### <a name="task6"></a>6. Complex types - mixed list
...
### <a name="task7"></a>7. Complex types - string and int/float to tuple
...
### <a name="task9"></a>9. Let's duck type an iterable object
