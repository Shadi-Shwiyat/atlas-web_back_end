...
### <a name="task2"></a>2. Create logger
...
### <a name="task3"></a>3. Connect to secure database
...
### <a name="task4"></a>4. Read and filter data
...
### <a name="task5"></a>5. Encrypting passwords
...
### <a name="task6"></a>6. Check valid password
